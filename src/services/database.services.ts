...
const uri = `mongodb+srv://${process.env.MONGO_USER}:${process.env.MONGO_PASSWORD}@block-hitter.0egzsww.mongodb.net/?retryWrites=true&w=majority&appName=block-hitter`;
